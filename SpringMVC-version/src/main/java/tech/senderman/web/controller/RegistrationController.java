...
import tech.senderman.persistence.model.Privilege;
import tech.senderman.persistence.model.User;
import tech.senderman.persistence.model.VerificationToken;
import tech.senderman.registration.OnRegistrationCompleteEvent;
import tech.senderman.security.ISecurityUserService;
import tech.senderman.service.IUserService;
import tech.senderman.web.dto.PasswordDto;
import tech.senderman.web.dto.UserDto;
import tech.senderman.web.error.InvalidOldPasswordException;
...
public class RegistrationController {
    ...
    private SimpleMailMessage constructResendVerificationTokenEmail(final String contextPath, final Locale locale, final VerificationToken newToken, final User user) {
        ...
        return constructEmail("Отправить регистрационный токен еще раз", message + " \r\n" + confirmationUrl, user);
    }

    private SimpleMailMessage constructResetTokenEmail(final String contextPath, final Locale locale, final String token, final User user) {
        final String url = contextPath + "/user/changePassword?id=" + user.getId() + "&token=" + token;
        final String message = messages.getMessage("message.resetPassword", null, locale);
        return constructEmail("Сброс пароля", message + " \r\n" + url, user);
    }
